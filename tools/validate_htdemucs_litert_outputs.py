#!/usr/bin/env python3
"""Validate device HTDemucs neural-core outputs against frozen Torch goldens."""
...
def main() -> int:
    ...
    frequency_shape = (1, 6, 4, 2048, frames)
    waveform_shape = (1, 6, 2, samples)
